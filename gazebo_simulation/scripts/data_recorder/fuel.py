...
class data_saving_node:
    ...
    def __init__(self):
        ...
        self.mavposeSub_ = rospy.Subscriber('/pcl_render_node/sensor_pose', PoseStamped, self.mavposeCallback)
        self.knownvolumeSub_ = rospy.Subscriber('/known_volume', PointStamped, self.knownvolumeCallback)
