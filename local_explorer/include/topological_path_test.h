#ifndef __TOPOLOGICAL_PATH_TEST_H__
#define __TOPOLOGICAL_PATH_TEST_H__
...
enum NavState
{
    NAV_IN_PATH, REACHED_GOAL
};

class TopologicalPathTest
{
public:
    TopologicalPathTest();
...
private:
    ...
    void ReplanCommandCallback(const std_msgs::Bool::ConstPtr& msg_ptr);
    ...
    ros::Subscriber replan_command_sub_;
